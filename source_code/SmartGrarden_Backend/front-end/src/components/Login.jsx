// src/components/Login.jsx – CHỈ THÊM STYLE GLOBAL ĐỂ FIX #root, GIỮ NGUYÊN CODE CỦA BẠN
...
const Login = ({ onLoginSuccess }) => {
    ...
    return (
        <>
            {/* CHỈ THÊM ĐOẠN NÀY ĐỂ FIX #root CHIẾM FULL MÀN HÌNH */}
            <style jsx global>{`
                html, body, #root {
